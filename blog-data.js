...
{
  id: "20260915-sui-on-first-day",

  title:
    "すいとおん。ふたりになった日。初めましてから、今のふたりになるまで。",
  ...
  image:
    "blog/images/sui-on-first-meet.jpg",

  lead:
    "多頭飼いなんてしたことがなかった私と、何も知らずに出会ったすいとおん。迎える前夜は不安で眠れなかったのに、当のふたりは思ったよりずっと自然に、少しずつ関係を作っていきました。",
  ...
  content: `
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-first-meet.jpg"
        alt="初めて会ったすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-first-sniff.jpg"
        alt="小さなおんの匂いを確認するすい"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/on-goes-to-sui.jpg"
        alt="初日からすいに積極的に近づくおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/on-attacks-sui.jpg"
        alt="すいに遊びを仕掛けるおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-early-days.jpg"
        alt="一緒に過ごし始めた頃のすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-solve-it.jpg"
        alt="自分たちでやり取りするすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-play-fight.jpg"
        alt="じゃれ合うすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-close-play.jpg"
        alt="近い距離で遊ぶすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-car-together.jpg"
        alt="車の中で一緒に過ごすすいとおん"
      >
    </figure>
    ...
    <figure class="article-photo">
      <img
        src="blog/images/sui-on-now.jpg"
        alt="現在のすいとおんがくっついて眠る様子"
      >
    </figure>
...
{
  id: "20260915-separation-anxiety",

  title:
    "軽度の分離不安と戦う、すいとおん。お留守番ができないすいと、兄ちゃんがいないと泣くおん。",
